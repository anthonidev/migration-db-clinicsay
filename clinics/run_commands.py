...
def get_command_status(clinic_folder: str, command: dict) -> str:
    ...
    if is_extract:
        ...
        output_files = {
            ...
            "extract_packs": "packs.json",
            "extract_room": "rooms.json",
            "extract_rooms": "rooms.json",
            "extract_availability": "availability_templates.json",
            ...
            "extract_patient_balances": "patient_balances.json",
            "extract_documents": "documents.json",
            "extract_appointments": "care_plans.json",
    ...
    if is_insert or is_create or is_update or is_configure:
        ...
        log_patterns = {
            ...
            "insert_packs": "insert_packs_2*.log",
            ...
            "insert_patient_balances": "insert_patient_balances_2*.log",
            "insert_documents": "insert_documents_2*.log",
            "insert_appointments": "insert_appointments_2*.log",
            "insert_appointments_simple": "insert_appointments_simple_2*.log",
            "insert_appointments_multi": "insert_appointments_multi_2*.log",
            "insert_appointments_packs": "insert_appointments_packs_2*.log",
